...
export class ModernPortfolioCarousel {
  ...
  updateProjects(newProjects) {
    ...
    this.projects = newProjects.map(p => ({
      ...
      niche: p.niche || 'Geral',
      primaryColor: p.primary_color || p.primaryColor || '#71717A',
      bgTint: p.bg_tint || p.bgTint || 'rgba(255, 255, 255, 0.08)',
      bgSection: p.bg_section || p.bgSection || '#000000',
      bgSectionLight: p.bg_section_light || p.bgSectionLight || '#F8FAFC',
      bgTintLight: p.bg_tint_light || p.bgTintLight || 'rgba(0, 0, 0, 0.04)',
